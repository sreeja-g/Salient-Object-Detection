...
class RefUnet(nn.Module):
    def __init__(self,in_ch,inc_ch):
        ...
        self.conv_d2 = nn.Conv2d(64,64,3,padding=1)
    ...
    def forward(self,x):
        ...
        d4 = self.relu_d4(self.bn_d4(self.conv_d4(hx+hx4)))
        hx = self.upscore2(d4)

        d3 = self.relu_d3(self.bn_d3(self.conv_d3(hx+hx3)))
        hx = self.upscore2(d3)

        d2 = self.relu_d2(self.bn_d2(self.conv_d2(hx+hx2)))
        hx = self.upscore2(d2)

        d1 = self.relu_d1(self.bn_d1(self.conv_d1(hx+hx1)))
